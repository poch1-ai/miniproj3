...
```{r fig.cap = "Figure 2. shows the net expansion vs contraction signal in the FOMC statements by year. Before 2020 ( Pre-Covid), exspansionary langauges increases then drops sharply during COVID shock, which shows more cautious economics communication by the federal reserve."}
#| results: 'hide'
#| fig-width: 5
#| fig-height: 3
#| out-width: "70%"
...
```{r fig.cap = "Figure 3. shows good vs bad economic terms in FOMC statement by year.Positive economic language dominates most years, while negative language increases during the COVID-19 shock (2020–2021), reflecting the economic disruption caused by the pandemic."}
#| results: 'hide'
 #| fig-width: 5
#| fig-height: 3
...
# Reference
[^1]: Federal Reserve. “The Fed - Federal Open Market Committee.” Board of Governors of the Federal Reserve System,<https://www.federalreserve.gov/monetarypolicy/fomc.htm.> Accessed 5 Mar. 2026
[^2]: ---. “The Fed - Meeting Calendars and Information.” Board of Governors of the Federal Reserve System,<https://www.federalreserve.gov/monetarypolicy/fomc.htm.> Accessed 2 Mar. 2026.